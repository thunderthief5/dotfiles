...
if test -f /home/thunderthief/miniconda3/bin/conda
    eval /home/thunderthief/miniconda3/bin/conda "shell.fish" "hook" $argv | source
else
    if test -f "/home/thunderthief/miniconda3/etc/fish/conf.d/conda.fish"
        . "/home/thunderthief/miniconda3/etc/fish/conf.d/conda.fish"
    else
        set -x PATH "/home/thunderthief/miniconda3/bin" $PATH
    end
end
# <<< conda initialize <<<
